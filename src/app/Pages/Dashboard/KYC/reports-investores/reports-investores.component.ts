...
declare const $:any;
@Component({
  selector: 'app-reports-investores',
  templateUrl: './reports-investores.component.html',
  styleUrls: ['./reports-investores.component.css']
})
export class ReportsInvestoresComponent implements OnInit {
