...
@Component({
  selector: 'app-refund-incomplete-opportunity',
  templateUrl: './refund-incomplete-opportunity.component.html',
  styleUrls: ['./refund-incomplete-opportunity.component.css']
})
export class RefundIncompleteOpportunityComponent implements OnInit {
...
banks =[
  ...
  ngOnInit() {
    this.usersService.getotppertinity().subscribe((res:any)=>{
      if (res.status) {
