...
@Component({
  selector: 'app-app-request-formb2-prtner',
  templateUrl: './app-request-formb2-prtner.component.html',
  styleUrls: ['./app-request-formb2-prtner.component.css']
})
export class AppRequestFormb2PrtnerComponent implements OnInit {
  ...
  error: string = "";
  info: any = null;
  fromAccounts: any = ["0190095517580024"];
