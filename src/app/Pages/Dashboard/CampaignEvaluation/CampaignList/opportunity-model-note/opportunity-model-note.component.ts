...
@Component({
  selector: "app-opportunity-model-note",
  templateUrl: "./opportunity-model-note.component.html",
  styleUrls: ["./opportunity-model-note.component.css"],
})
export class OpportunityModelNoteComponent implements OnInit {
  notes: any;
  note: string = "";
  Admin_name: string;
  Admin_Id: any;
